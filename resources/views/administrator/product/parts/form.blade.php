                            ...
                            @if ($product->is_variation)
                                @foreach ($product->stocks as $stock)
                                    <tr>
                                        ...
                                        <td><input type="number" name="stock[{{ $stock->uuid }}][quantity]" class="form-control variation-quantity" value="{{ $stock->quantity }}" required min="1"></td>
                                        <td><input type="number" name="stock[{{ $stock->uuid }}][price]" class="form-control variation-price" value="{{ $stock->price }}" required step=".001" min="0.1"></td>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="quantity" value="{{ old('quantity', $stock->quantity) }}" id="quantity" required min="1">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="price" value="{{ old('price', $stock->price) }}" id="price" required step=".001" min="0.1">
                </div>
            </div>
        </div>
    @endforeach
