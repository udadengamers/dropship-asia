<x-seller.auth-layout>
    ...
    @endpush
    @section('title', 'Choose Withdraw Method')
    <div class="my-ignored-div d-md-none" style="margin-top: -3rem;"></div>
    <form action="{{ route('seller.withdraw.index') }}" method="get" class="p-3">
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
              <img style="width:50px" src="/img/bitcoin.svg" alt="">
              <span class="mx-3">Wallet withdrawal</span>
            </div>
